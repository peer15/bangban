...
@section('title', 'Mitra Aktif')

@section('content')
<h2 class="text-xl font-semibold text-gray-800 mb-6">✅ Mitra Aktif & Nonaktif</h2>

@if($mitras->isEmpty())
    <div class="bg-white rounded-xl shadow-sm p-8 text-center text-gray-400">Belum ada mitra.</div>
@else
    <div class="space-y-4">
